...
public class UserInterfaceActivityForMVP extends BaseActivity implements CountriesPresenter.ViewPresenter {
...
//                getViewByDate(dateFormUser);
    ...
    private void getViewByDate(String date) {
        ...
        try {
            ...
            if (date1.after(date5) || date1.equals(date5)) {
                ...
                _000KmTxtView.setVisibility(View.VISIBLE);
    ...
    private void moveEnteredValueToResultActivity() {
        ...
        Intent userInputIntentData = new Intent(UserInterfaceActivityForMVP.this, ResultActivityForMVP.class);
    ...
    public void setValues(List<String> countries) {
        cityNameArray.clear();
        cityNameArray.addAll(countries);
        spinnerAdapter.notifyDataSetChanged();
    ...
    public void onError(String errorMsg) {
        ...
        Log.d("onFailuar", "Api Countries: " + errorMsg);
        Toast.makeText(getApplicationContext(),
                "onError fetchCountries " + errorMsg,
                Toast.LENGTH_LONG).show();
    }
}